...
class Configuration:
    ...
    def __init__(self, file_name):
        ...
        try:
            ...
            self.test_data_container_name = encode(conf['test_data_container_name'])
...
# create the container that will host the testing data blobs
blob_service.create_container(cfg.test_data_container_name, fail_on_exist=False)
